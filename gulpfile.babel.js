...
// 'gulp semantic' -- copies semantic to the temporary assets folder
gulp.task('semantic', () =>
  gulp.src('src/assets/semantic/**/*')
    .pipe(gulp.dest('.tmp/assets/semantic'))
    .pipe($.size({title: 'semantic'}))
);

// 'gulp vendor-scripts' -- copies vendor scripts to the temporary assets folder
gulp.task('vendor-scripts', () =>
  gulp.src('src/assets/javascript/vendor/**/*')
...
gulp.task('serve', () => {
  ...
  gulp.watch('src/assets/semantic/**/*', gulp.series('semantic'));
  gulp.watch('src/assets/javascript/vendor/**/*', gulp.series('vendor-scripts'));
});
...
gulp.task('assets', gulp.series(
  ...
  gulp.parallel('styles', 'scripts', 'fonts', 'images', 'semantic', 'vendor-scripts')
));
